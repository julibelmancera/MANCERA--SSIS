...
class Student:
    ...
    def __init__ (self,root):
        ...
        MainFrame = Frame(self.root, bd=7, width=1300, height=750, relief=RIDGE, bg="blue")
        MainFrame.grid()
        
        TopFrame1 = Frame(MainFrame,  width=1330, height=130, relief=RIDGE,bg="pink")
        TopFrame1.grid(row=2, column=0)
        
        TitleFrame = Frame(MainFrame, bg="blue",bd=5, width=1340, height=100, relief=RIDGE)
        ...
        LeftFrame = Frame(TopFrame2, bd=5, width=1350, height=400, padx=2, bg="pink", relief=RIDGE)
        LeftFrame.pack(side=LEFT)
        
        LeftFrame1 = Frame(LeftFrame, bd=5,bg="blue", width=600, height=300, padx=2, pady=4, relief=RIDGE)
        LeftFrame1.pack(side=TOP, padx=0, pady=0)
        
        RightFrame1 = Frame(TopFrame2, bd=5, width=600, height=400, padx=2, bg="blue", relief=RIDGE)
        ...
        self.lblStudentID = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="STUDENT ID:",bg="violet", bd=5 , anchor=W)
        ...
        self.lblLastName = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="LAST NAME:",bg="violet",bd=7, anchor=W)
        ...
        self.lblFirstName = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="FIRST NAME:",bg="violet", bd=7, anchor=W)
        ...
        self.lblMiddleName = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="MIDDLE NAME:", bg="violet",bd=7, anchor=W)
        ...
        self.lblCourse = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="COURSE:",bg="violet", bd=7, anchor=W)
        ...
        self.lblGender = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="GENDER:", bg="violet",bd=7, anchor=W)
        ...
        self.lblYearLevel = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="YEAR LEVEL:", bg="violet",bd=7, anchor=W)
        ...
        self.btnAddNew=Button(self.root, pady=1,bd=4,font=('arial',16,'bold'), padx=12, width=8,fg="Green", text='ADD', command=addStudent)
        self.btnAddNew.place(x=50,y=519)
        
        self.btnClear=Button(self.root, pady=1,bd=4,font=('arial',16,'bold'), padx=2, width=8,fg="Green", text='CLEAR', command=Clear)
        self.btnClear.place(x=195,y=519)
        
        self.btnUpdate=Button(self.root, pady=1,bd=4,font=('arial',16,'bold'), padx=2, width=8,fg="Green", text='UPDATE', command=updateData)
        self.btnUpdate.place(x=570,y=520)

        self.btnEdit=Button(self.root, pady=1,bd=4,font=('arial',16,'bold'), padx=2, width=8,fg="Green", text='EDIT', command = editData)
        self.btnEdit.place(x=445,y=520)

        self.btnDisplay=Button(self.root, pady=1,bd=4, font=('arial', 16, 'bold'),padx=2,width=8, fg="Green",text="DISPLAY" , command=displayData)
        self.btnDisplay.place(x=320,y=520)


        self.btnDelete=Button(self.root, pady=1,bd=4,font=('arial',16,'bold'), padx=2, width=8,fg="Green", text='DELETE',command = deleteData)
        self.btnDelete.place(x=700,y=520)

        self.btnExit=Button(self.root, pady=1,bd=4,font=('arial',16,'bold'), padx=2, width=8,fg="Green", text='EXIT',command = iExit)
        self.btnExit.place(x=1150,y=480)

        self.btnSearch=Button(self.root, pady=1,bd=4,font=('arial',11,'bold'), padx=2, width=10, text='Search by ID',bg="Yellow", command = searchData)
